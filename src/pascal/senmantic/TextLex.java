...
public class TextLex {
    ...
    public int handleFirstAlpha(int arg, String arg0) {
        ...
        switch (s) {
            case "PROGRAM":
                tokenList.add(new Token(s, Token.TokenKind.PROGRAM));
                break;
            case "BEGIN":
                tokenList.add(new Token(s, Token.TokenKind.BEGIN));
                break;
            case "END":
                tokenList.add(new Token(s, Token.TokenKind.END));
                break;
            case "INTEGER":
                tokenList.add(new Token(s, Token.TokenKind.INTEGER));
                break;
            case "IF":
                tokenList.add(new Token(s, Token.TokenKind.IF));
                break;
            case "ELSE":
                tokenList.add(new Token(s, Token.TokenKind.ELSE));
                break;
            case "THEN":
                tokenList.add(new Token(s, Token.TokenKind.THEN));
                break;
            case "VAR":
                tokenList.add(new Token(s, Token.TokenKind.VAR));
                break;
            case "WHILE":
                tokenList.add(new Token(s, Token.TokenKind.WHILE));
                break;
            case "DO":
